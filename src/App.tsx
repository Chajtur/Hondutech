...
export default function App() {
  ...
  const companyData = {
    ...
    subtitle:
      "Unimos desarrollo web, integraciones y automatización para que empresas operen mejor, vendan más y pierdan menos tiempo.",
    whatsappUrl: "https://wa.me/50487955286",
    projectsCtaText: "Hola, me interesa conocer más sobre el proyecto:",
  };
  ...
  const services = [
    ...
    },
    {
      ...
      desc: "Landings, sistemas internos y paneles hechos para conversión, operación y crecimiento.",
    },
    {
      title: "Bots y mensajería SMS",
      desc: "Flujos de SMS, recordatorios y notificaciones conectadas con tus plataformas actuales.",
    },
    {
      title: "Soporte y mejora continua",
      desc: "Mantenimiento, mejoras y nuevos módulos sobre productos que ya están generando valor.",
    },
  ];

  const projects: Project[] = [
    {
      title: "Interglobal CRM y automatización operativa",
      desc: "Evolución de CRM en PHP para operación de call center, gestión interna e integraciones empresariales.",
      tag: "PHP · CRM · Operaciones",
      impact: "Centralizó flujos de ventas, seguimiento y soporte en un solo sistema.",
      link: "https://app.interglobalus.com/",
    },
    {
      title: "Integración y sincronización SMS con Ooma",
      desc: "Automatización de login, token y descarga de conversaciones para consolidar mensajes en CRM.",
      tag: "APIs · SMS · Automatización",
      impact: "Redujo tiempo de atención y eliminó trabajo manual de copia/pega.",
    },
    {
      ...
      impact: "Aceleró la disponibilidad de leads para el equipo comercial.",
    },
    {
      title: "WebMasterHR",
      desc: "Sistema web para reemplazar archivos de Excel de RRHH por una plataforma con base de datos.",
      tag: "HR Tech · Migración",
      impact: "Estandarizó procesos internos y mejoró trazabilidad de información.",
      link: "https://hr.iccbpohn.com/",
    },
    {
      title: "SMS Companion Backend",
      desc: "Base para servicios de mensajería, recordatorios y automatizaciones comerciales sobre infraestructura SMS.",
      tag: "Backend · SaaS",
      impact: "Aportó cimientos para nuevos módulos de comunicación escalables.",
    },
    {
      title: "Corta.la",
      desc: "Proyecto orientado a enlaces cortos y utilidades digitales para marketing y seguimiento.",
      tag: "Utility · Marketing",
      impact: "Abre opciones de tracking y branding para campañas digitales.",
      link: "https://corta.la/",
    },
    {
      ...
      tag: "Web · Comunidad",
      impact: "Mejoró visibilidad y comunicación del proyecto con su audiencia.",
      link: "https://mayafc.futbol/",
    },
    {
      title: "Herramientas internas y landings a medida",
      desc: "Dashboards, formularios, módulos administrativos y utilidades para operación real.",
      tag: "Custom Dev",
  ...
  const quickBullets = [
    "Landing pages enfocadas en captación de leads",
    "Sistemas internos y paneles administrativos",
    "Automatización de tareas, reportes y seguimiento",
    "Integración de APIs y plataformas externas",
    "Herramientas de productividad para equipos",
    "Módulos utilitarios como este generador de passwords",
  ];
  ...
  const strength = useMemo(() => {
    ...
    if (variety === 0) {
      return { label: "Inválida", widthClass: "w-0", colorClass: "bg-rose-500" };
    }
    if (rawScore < 25) {
      return { label: "Débil", widthClass: "w-1/4", colorClass: "bg-rose-500" };
    }
    if (rawScore < 45) {
  ...
  const applyPreset = (presetName: 'web' | 'saas' | 'high') => {
    if (presetName === "web") {
      setLength(12);
  ...
  const buildOnePassword = (safeLength: number) => {
  ...
  const generatePasswords = () => {
    ...
    if (safeLength < activeSets.length) {
      setErrorText("La longitud debe ser mayor o igual al número de tipos seleccionados.");
      setGenerated([]);
      setCopiedIndex(null);
      setCopiedAll(false);
      return;
    ...
    <div className="min-h-screen bg-black text-white">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              <div className="mb-6 flex flex-wrap items-center gap-4">
                <img
                  src={Logo}
                  alt="Logo de Hondutech"
                  className="h-14 w-auto rounded-2xl border border-cyan-400/30 bg-slate-950 object-contain p-1 shadow-lg shadow-cyan-500/20"
                />
      ...
      <section id="passwords" className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <p className="mt-4 text-slate-300">
              Esta herramienta gratuita te permite crear passwords seguras y personalizadas al instante. 
              Ajusta longitud, tipos de caracteres y cantidad para generar claves robustas que protejan tus cuentas. 
          ...
          <div className="rounded-3xl border border-blue-500/10 bg-slate-950 p-6">
            ...
            <div className="mt-5 rounded-2xl border border-blue-500/10 bg-black p-4 text-sm text-slate-300">
              <p className="font-semibold text-cyan-300">Tip rápido de seguridad</p>
              <p className="mt-2">
                Usa passwords distintas por plataforma y guarda todo en un password manager. Este generador te ayuda a
                crear claves robustas, pero la gestión segura también importa.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="border-t border-blue-500/10 bg-black">
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 px-6 py-10 lg:flex-row lg:items-center lg:px-8">
          <div>
            <h3 className="text-2xl font-bold">Quieres una web útil, rápida y hecha para negocio?</h3>
            <p className="mt-2 text-slate-400">
              Hondutech construye soluciones para operar, automatizar y convertir. Desde integraciones serias hasta
              herramientas pequeñas que atraen clientes.
            </p>
          </div>
          <a
